...
function App() {
  ...
  const setDarkMode = () => {
      document.querySelector('body').setAttribute('ClassName', 'dark')
  }
  const setLightMode = () => {
      document.querySelector('body').setAttribute('ClassName', 'light')
  }
  const toggleTheme = () => {
  ...
  return (
 <ThemeContext.Provider value={{sunSvg, moonSvg, isDarkTheme, toggleTheme, icon }}>
    <div className="App">
      <Container>
        <Header sunSvg={sunSvg} moonSvg={moonSvg}/>
        <SearchBar />
        <DevInfo />
      </Container>
    </div>
